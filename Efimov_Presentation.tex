...
\end{itemize}
\column{0.6\textwidth}
\only<1,3->{\includegraphics[width=1.0\linewidth]{efimov1}}
\only<2>{\includegraphics[width=1.0\linewidth]{efimov2}}
\end{columns}
...
\frametitle{Efimov-like Potentials $\xi(\rho)$ for Different $a$}
	...
	\only<1>{
	\centering
	\includegraphics[width=1.0\linewidth]{infty.pdf}}
	\only<2-5>{
	\centering
	\includegraphics[width=1.0\linewidth]{infty_opac.pdf}}
	\only<1-2,5>{
	\centering
	\includegraphics[width=1.0\linewidth]{finite_positive_a_opac.pdf}}
	\only<3-4>{
	\centering
	\includegraphics[width=1.0\linewidth]{finite_positive_a.pdf}}
	\column{0.5\textwidth} %New column
	\only<1,3-5>{
	\centering
	\includegraphics[width=1.0\linewidth]{finite_negative_a_opac.pdf}}
	\only<2>{
	\centering
	\includegraphics[width=1.0\linewidth]{finite_negative_a.pdf}}
	\only<4>{
	\centering
	\includegraphics[width=.97\linewidth]{finite_conv_asym.pdf}}
	\only<5>{
	\centering
	\includegraphics[width=1.0\linewidth]{finite_conv.pdf}}
	\only<1-3>{
	\centering
...
\visible<1-4>{
\begin{textblock*}{9cm}(-0.2\textwidth,-0.07\textheight)%
...
\frametitle{Comparison to the Analytical Model (2)}
	...
	\begin{textblock*}{3cm}(.\textwidth,-0.05\textheight)%
	\hyperlink{R_faddeev}{\beamerreturnbutton{$\nu_0(\rho/a)$}}     \end{textblock*}
\end{frame}
