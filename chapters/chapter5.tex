...
Thereafter we choose collocation at the knot points and require that \Cref{expansion} is a solution to \Cref{adiabatic} at those points. Since only $(k-1)^2$ B-splines are non-zero at the knot points, it means that each equation involves $(k-1)^2$ B-splines
