...
\subsubsection{The Efimov Effect}
In 1970, Vitaly Efimov discovered an effect in the energy spectra predicted the existence   

The notion of Efimov physics comprise a range of phenomena that occurs in systems exibiting the Efimov effect, named after its discovered in 1970 by . The Efimov effect was discovered in by \cite{Efimov:1970zz}

\subsection{The Three-body Problem}
The $n$-body problem is a class of problems in physics which, in a highly general sense, consists of modelling the motion of $n$ objects, interacting through some physical force. In classical mechanics the general equations of motion for point masses are derived from Newton's second law of motion, which states that the rate of change in momentum for an object equals the force acting on it. The quantum mechanical analog to the classical equations of motion is the Schr{\"o}dinger equation 
